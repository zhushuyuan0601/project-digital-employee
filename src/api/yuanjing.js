...
const YUANJING_CONFIG = {
  baseURL: 'https://api.yuanjing.com/v1', // 替换为实际 API 地址
...
const api = axios.create({
  baseURL: YUANJING_CONFIG.baseURL,
  headers: {
 ...
 */
export async function chatWithYuanjing(message) {
  try {
    // 添加用户消息到历史
...
请用简洁友好的语言回答用户问题。如果问题超出你的能力范围，建议用户转接人工客服。`
        ...
        ...conversationHistory.slice(-10) // 保留最近 10 轮对话
      ],
      temperature: 0.7,
      max_tokens: 500
    }
...
function getMockReply(message) {
  const mockReplies = {
    '套餐': '您当前使用的是联通 5G 套餐，月费 99 元，包含：\n• 国内流量：20GB\n• 国内语音：200 分钟\n• 短信：100 条\n\n如需变更套餐，请回复"变更套餐"或拨打 10010。',
    '充值': '话费充值方式：\n\n1️⃣ 微信充值：打开微信 - 我 - 服务 - 手机充值\n2️⃣ 支付宝充值：打开支付宝 - 充值中心\n3️⃣ 联通 APP：登录联通 APP-充值缴费\n4️⃣ 拨打 10011 电话充值\n\n请问您需要哪种方式？',
